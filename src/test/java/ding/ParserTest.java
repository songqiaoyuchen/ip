...
public class ParserTest {
    ...
    void parse_bye_returnsExitCommand() throws DingException {
    ...
    void parse_list_returnsListCommand() throws DingException {
    ...
    void parse_mark_valid_returnsMarkCommand() throws DingException {
    ...
    void parse_unmark_valid_returnsUnmarkCommand() throws DingException {
    ...
    void parse_delete_valid_returnsDeleteCommand() throws DingException {
    ...
    void parse_todo_missingDesc_throws() {
    ...
    void parse_todo_valid_returnsTodoCommand() throws DingException {
    ...
    void parse_deadline_valid_returnsDeadlineCommand() throws DingException {
    ...
    void parse_event_missingFields_throws() {
    ...
    void parse_event_valid_returnsEventCommand() throws DingException {
